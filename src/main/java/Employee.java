...
public class Employee {
    ...
    public static Employee generateOne(String nameSuffix){
        return new Employee("       Employeee ", random.nextInt(100), 1000 + random.nextDouble()*5000, random.nextInt(100)/100.0d, new Date(current - (1000000 + random.nextInt(1000000))));
    }
